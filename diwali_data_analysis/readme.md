This project analyzes **Diwali sales data** to explore the customer purchasing patterns, most sold products, and sales trends using python and data visualization libraries.
